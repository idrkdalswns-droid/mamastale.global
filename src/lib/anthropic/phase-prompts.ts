...
**최소 품질 기준 (반드시 충족):**
- 각 장면은 최소 150자 이상 작성하세요 (1-2문장짜리 빈약한 장면 금지)
- 전체 10장면 합산 최소 1,500자 이상이어야 합니다
- 등장인물 간 대화(따옴표 대사)를 최소 5회 이상 포함하세요
- 최소 3명 이상의 등장인물이 등장해야 합니다 (주인공 + 아이 + 조력자/괴물)
- 각 장면에 구체적인 배경 묘사(시각/청각/촉각)를 포함하세요
- 장면 번호와 이름을 빠뜨리지 마세요 ([INTRO 1], [CONFLICT 1] 등)
</story_quality_requirements>
