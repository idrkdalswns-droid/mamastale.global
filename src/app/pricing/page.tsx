      ...
      <div className="relative z-[1] max-w-lg mx-auto px-6 pt-12 pb-28">
        ...
        <section className="mb-10">
          ...
          <p className="text-[11px] text-brown-light font-light text-center mb-5">
            마마스테일 대표의 실제 사연을 바탕으로 만들어진 동화입니다
          </p>
          <div
          ...
          >
            {[
              ...
              "\"이 반짝이는 글쓰기 마법을 엄마들에게도 선물해야겠다!\" 그렇게 삼촌의 따뜻한 마음이 모여, 엄마가 적은 글이 아이에게 들려줄 동화로 변하는 마법 서재 '마마스테일'이 태어났단다. 엄마에게 가서 말해봐. \"엄마! 엄마 동화 들려주세요!\" 오늘 밤 엄마의 이야기 속에는 세상을 다 녹일 만큼 따뜻한 사랑이 숨어 있단다.",
            ].map((text, i) => (
              <div
                key={i}
