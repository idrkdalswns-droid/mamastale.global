...
const AUTHOR_TESTIMONIALS: Record<string, string> = {
  ...
  "별빛 엄마":
    "사업을 하면서 아이에게 충분히 함께하지 못한다는 죄책감이 늘 있었어요. 동화를 만들면서 '완벽하지 않아도 된다'는 걸 처음으로 마음으로 느꼈습니다. 딸아이가 이 동화를 읽고 \"엄마 나비가 엄마랑 닮았어!\"라며 안겨올 때, 그동안의 미안함이 사랑으로 바뀌는 느낌이었어요.",
  "새벽빛 엄마":
    "아동심리 전문가로 일하면서도 정작 제 감정 앞에선 무력했어요. 대화를 나누며 '아는 것'과 '느끼는 것'이 다르다는 걸 깨달았습니다. 아들이 동화 속 부엉이를 보며 \"엄마도 울어도 돼\"라고 말해줬을 때, 그 한마디가 어떤 이론보다 치유가 됐어요.",
  "무지개 엄마":
...
// Sprint 2-G: Preview scene count for non-members
const PREVIEW_SCENE_COUNT = 2;
