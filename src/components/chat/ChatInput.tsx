...
import { abortCurrentRequest } from "@/lib/hooks/useChat";
    ...
    >
      ...
      >
        ...
        <div className="relative">
          ...
          {/* Route-Hunt 7-2: Cancel button during streaming */}
          <button
            onClick={isLoading ? handleCancel : handleSend}
            disabled={!isLoading && isDisabled}
            aria-label={isLoading ? "응답 중단" : "메시지 보내기"}
            ...
            style={{
              ...
              color: "#fff",
              boxShadow: isLoading
                ? "0 3px 12px rgba(224,122,95,0.3)"
